...
'Advertisement ID
smsAdvID = colNamedArguments.Item("adv")
...
' Execute WMI Query
Set oQueryResults = oSWbemServices.ExecQuery("Select * From SMS_AdvertisementStatusRootSummarizer Where AdvertisementID=""" & smsAdvID & """")
